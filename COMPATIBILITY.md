...
The [specification decision register](docs/specification-decisions.md) defines
the supported OTLP, W3C propagation, baggage, and semantic-convention profiles.
